...
- China reports cases as of late January, has a maximuum of 15k cases/day first week of February but reduces new cases drastically to 1k/day end February and further to 100 cases/day in March. April and May
...
- few countries have 2 weeks of very low new cases afte their peak: China, Sout Korea, Japan, Switzerland, Austria, Denmark, Israel, Serbia
...
df50 %>% 
  ...
  filter(n > 0) %>% 
	...
	animate(p, width = 1920/2, height = 1080/2, fps=10, duration=20, end_pause=5)  %>%
...
- Brazil will have 2 million confirmed cases and be very close to USA
