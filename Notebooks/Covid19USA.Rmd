...
```{r,warning=FALSE}
####################################################################
# USA New Cases and deaths per day
####################################################################
...
USStates.Covid19.all %>% 
      ...
      scale_x_date(date_breaks="1 month", date_labels = "%b") +
	    scale_y_log10(limits=c(100,10^5), breaks = logTicks(n=4),  minor_breaks = logTicks(n=40), labels = trans_format("log10", math_format(10^.x))) +
...
```{r,warning=FALSE, fig.width=18, fig.asp=.4}
####################################################################
#  USA per region  New Cases and deaths per day
####################################################################

USStates.Covid19.all %>% 
		filter(Metric %in% c('Confirmed','Deaths'), Metric2 == 'delta') %>%
		group_by(REGION, Metric, Date) %>% 
	  summarise_at('val', sum) %>%
	  ggplot(aes(x=Date, y=val, colour=REGION)) +
      geom_point(shape=1, size=2) + 
	    geom_smooth(formula ='y ~ x',method = 'loess', span=0.40) +
      scale_x_date(date_breaks="1 month", date_labels = "%b") +
	    scale_y_log10(limits=c(100,10^5), breaks = logTicks(n=4),  minor_breaks = logTicks(n=40), labels = trans_format("log10", math_format(10^.x))) +
	    annotation_logticks(sides="lr") +
	    labs(title="USA Refion Cases and Deaths per Day", subtitle = paste("Covid19 pandemic","-",date()), x="Time(2020)", y="Count") +
...
```{r,warning=FALSE, fig.width=18, fig.asp=.4}
####################################################################
#  USA per division  New Cases and deaths per day
####################################################################

USStates.Covid19.all %>% 
		filter(Metric %in% c('Confirmed','Deaths'), Metric2 == 'delta') %>%
		group_by(DIVISION, Metric, Date) %>% 
	  summarise_at('val', sum) %>%
	  ggplot(aes(x=Date, y=val, colour=DIVISION)) +
      geom_point(shape=1, size=2) + 
	    geom_smooth(formula ='y ~ x',method = 'loess', span=0.40) +
      scale_x_date(date_breaks="1 month", date_labels = "%b") +
	    scale_y_log10(limits=c(100,10^5), breaks = logTicks(n=4),  minor_breaks = logTicks(n=40), labels = trans_format("log10", math_format(10^.x))) +
	    annotation_logticks(sides="lr") +
	    labs(title="USA Region Cases and Deaths per Day", subtitle = paste("Covid19 pandemic","-",date()), x="Time(2020)", y="Count") +
	    facet_wrap(vars(Metric)) +
	    theme_bw() 
```
...
PlotStateMap <- function (m1="Confirmed", m2='n', pc=FALSE) {
  ...
  theme_map() + 
	...
	scale_fill_viridis( option = "inferno", direction = +1, name = "", limits= c(NA,NA), breaks=10^seq(0,5),
...
USStates.Covid19 %>%
  ...
  #scale_x_log10(limits=c(10,NA), breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
	scale_x_log10(limits=c(10,NA), breaks = logTicks(n=5),  minor_breaks = logTicks(n=50), labels = trans_format("log10", math_format(10^.x))) +
...
USStates.Covid19 %>%
  ...
  #scale_x_log10(limits=c(10,NA), breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
	scale_x_log10(limits=c(10,NA), breaks = logTicks(n=3),  minor_breaks = logTicks(n=30), labels = trans_format("log10", math_format(10^.x))) +
	annotation_logticks(sides="b") +
	scale_y_continuous(limits=c(-1,3), labels = scales::percent_format(accuracy = 1)) +
...
####################################################################
# New Cases per  vs increase in new cases in the last 2 weeks 
incstates <- c('MA','NY','NH', 'CT', 'ME', 'VT', 'CA','FL','TX','AZ')
incstates <- c('MA','FL', 'NY','AZ')
...
USStates.Covid19.all %>%
	...
	{
  ggplot(., aes(x = Date , y = rel14, group = USPS)) +
	geom_point(color= 'gray',shape=1) +
  geom_smooth(color= 'gray',formula ='y ~ x', method = 'loess', span=0.10, se=FALSE) +
	geom_point(data=filter(., USPS %in% incstates), aes(color=USPS), shape=1) +	
	geom_smooth(data=filter(., USPS %in% incstates), aes(color=USPS), formula ='y ~ x',method = 'loess', span=0.10, se=FALSE) +	
	geom_hline(yintercept = 0)	+	
  scale_x_date(date_breaks="1 month", date_labels = "%b", date_minor_breaks = "1 week") +
	scale_y_continuous(limits=c(-1,3), labels = scales::percent_format(accuracy = 1)) +
	labs(title="Acceleration over time", subtitle = paste("Covid19 pandemic","-",date()), x="Time (2020)", y="Relative Increase (%)") +
	theme_bw() }	-> p3

USStates.Covid19.all %>%
	filter(Metric == "Confirmed", Metric2 %in% c('delta14', 'rel14')) %>% 
	pivot_wider(names_from=c("Metric2"), values_from="val") %>% 
	mutate(delta14 = 10^5 * delta14 / POPESTIMATE2019 / 14) %>% 
	filter(Date >date("2020-04-01")) %>%
	{
  ggplot(., aes(x = delta14 , y = rel14, group = USPS)) +
	geom_point(color= 'gray',shape=1) +
	geom_path(color= 'gray') +
	geom_point(data=filter(., USPS %in% incstates), aes(group=USPS, color=USPS), shape=1) +	
	geom_path(data=filter(., USPS %in% incstates), aes(group=USPS, color=USPS),alpha=1) +	
	geom_hline(yintercept = 0)	+	
  #scale_x_log10(limits=c(10,NA), breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
	scale_x_log10(limits=c(1,NA), breaks = logTicks(n=2),  minor_breaks = logTicks(n=20), labels = trans_format("log10", math_format(10^.x))) +
	annotation_logticks(sides="bt") +
	scale_y_continuous(limits=c(-1,3), labels = scales::percent_format(accuracy = 1)) +
	labs(title="New Cases/Capita and Acceleration", subtitle = paste("Covid19 pandemic","-",date()), x="New cases/capita per day", y="Relative Increase (%)") +
	theme_bw() }	-> p4
...
USStates.Covid19.all %>%
	filter(Metric == "Confirmed", Metric2 %in% c('delta14', 'rel14')) %>% 
	group_by(DIVISION, Metric2, Date) %>% 
	summarise_at('val', sum) %>%
	pivot_wider(names_from=c("Metric2"), values_from="val") %>% 
	filter(Date >date("2020-04-01")) %>% 
	{
  ggplot(., aes(x = Date , y = rel14, group = DIVISION)) +
	geom_point(aes(color=DIVISION), shape=1) +	
	geom_smooth(aes(color=DIVISION), formula ='y ~ x',method = 'loess', span=0.10, se=FALSE) +	
	geom_hline(yintercept = 0)	+	
  scale_x_date(date_breaks="1 month", date_labels = "%b", date_minor_breaks = "1 week") +
	scale_y_continuous(limits=c(-1,3), labels = scales::percent_format(accuracy = 1)) +
	labs(title="Acceleration over time", subtitle = paste("Covid19 pandemic","-",date()), x="Time (2020)", y="Relative Increase (%)") +
...
USStates.Covid19.all %>%
	filter(Metric == "Confirmed", Metric2 %in% c('delta14', 'rel14')) %>% 
	group_by(DIVISION, Metric2, Date) %>% 
	summarise_at(c('val','POPESTIMATE2019'), sum) %>%
	pivot_wider(names_from=c("Metric2"), values_from="val") %>% 
	mutate(delta14 = 10^5 * delta14 / POPESTIMATE2019 / 14) %>% 
	filter(Date >date("2020-04-01")) %>%
	{
  ggplot(., aes(x = delta14 , y = rel14, group = DIVISION)) +
	geom_point(aes(group=DIVISION, color=DIVISION), shape=1) +	
	geom_path(aes(group=DIVISION, color=DIVISION),alpha=1) +	
	geom_hline(yintercept = 0)	+	
 	scale_x_log10(limits=c(1,NA), breaks = logTicks(n=2),  minor_breaks = logTicks(n=20), labels = trans_format("log10", math_format(10^.x))) +
	annotation_logticks(sides="bt") +
	scale_y_continuous(limits=c(-1,3), labels = scales::percent_format(accuracy = 1)) +
...
USStates.Covid19.all %>%  
  ...
  geom_tile(aes(fill=rval)) + 
	scale_x_date(limits = c(date("2020-02-29"), NA), date_breaks="1 month", date_labels = "%b") +
	...
	filter(., STNAME %in% gettop(.,25), val > 9)  %>%
      ...
      scale_x_date(date_breaks="1 month", date_labels = "%b", date_minor_breaks = "1 week") +
	    #scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
	  	scale_y_log10(breaks = logTicks(n=6),  minor_breaks = logTicks(n=60), labels = trans_format("log10", math_format(10^.x))) +
	    annotation_logticks(sides="lr") +
...
USStates.Covid19.all %>%  
  ...
  {	ggplot(data=., aes(x=Date, y=val, colour=STNAME)) +
    ...
    geom_label_repel(data=filter(., Date==max(Date)), aes(label = paste(USPS, ns(val,1), sep=":")), nudge_x=2) +
	  scale_x_date(date_breaks="1 month", date_labels = "%b", date_minor_breaks = "1 week") +
	  #scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
  	scale_y_log10(breaks = logTicks(n=4),  minor_breaks = logTicks(n=40), labels = trans_format("log10", math_format(10^.x))) +
	  annotation_logticks(sides="lr") +
...
USStates.Covid19.all %>%  
  ...
  {	ggplot(data=., aes(x=Date, y=rval)) +
    ...
    geom_label_repel(data=filter(., Date==max(Date) | val==max(val)), aes(label = ns(val)), nudge_x=2) +
	  scale_x_date(limits=c(date("2020-3-1"),NA), date_breaks="1 month", date_labels = "%b") +
...
USCounties.Covid19.all %>% 
  ...
  geom_point(shape=1, size=3) + 
	...
	scale_x_date(date_breaks="1 month", date_labels = "%b", date_minor_breaks = "1 week") +
	#scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),labels = trans_format("log10", math_format(10^.x))) +
	scale_y_log10(breaks = logTicks(n=5),  minor_breaks = logTicks(n=50), labels = trans_format("log10", math_format(10^.x))) +
	annotation_logticks(sides="lr") +
...
####################################################################
# Graphical Exploration US Counties in the North-East heatmaps on geomaps
####################################################################

NE <- filter(USStates, REGION == "Northeast") %>% pull (STATE)

PlotNECountyMap <- function (m1="Confirmed", m2='n', pc=FALSE) {
	filter(USCounties.Covid19 , Metric == m1, Metric2 == m2 ) %>% 
	mutate(val = pc * (10^5 * val / POPESTIMATE2019) + (1-pc) *val) %>% 
	left_join(map.county, ., by="FIPS") %>% 
	...
	ggplot(aes(x = long, y = lat)) +
  geom_polygon(aes(group = group, fill=val)) +
  geom_path(data=filter(map.state, STATE %in% NE), aes(x = long, y = lat, group = group), colour = "white", size=.2) +
	drawLabels(paste("US North-East", m1, m2, "; per Capita =", pc)) +	
  theme_map() + 
	coord_map () +
	theme(legend.position = "right") +
	scale_fill_viridis( option = "inferno", direction = +1, name = "", limits= c(0,NA), breaks=10^seq(0,5),
...
# generate county plots
expand.grid(pc=c(FALSE,TRUE), m1=c("Confirmed",'Deaths'), m2=c('n','delta','delta7')) %>% 
#expand.grid(pc=c(FALSE), m1=c("Confirmed"), m2=c('n','delta','delta7')) %>% 	
	{ mapply(PlotNECountyMap, m1=.$m1, m2=.$m2, pc=.$pc, SIMPLIFY = FALSE) } %>%
  grid.arrange( grobs = ., nrow=6, heights=rep(4,6))
```  
...
if(wday(today(), label=TRUE) == "xxx") { # broken, takes too much memory, this takes hours to compute, only do this once a week on Sunday
...
#	scale_x_log10(limits=c(100,NA), breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
	scale_x_log10(breaks = logTicks(n=5),  minor_breaks = logTicks(n=50), labels = trans_format("log10", math_format(10^.x))) +
	scale_y_log10(breaks = logTicks(n=5),  minor_breaks = logTicks(n=50), labels = trans_format("log10", math_format(10^.x))) +
...
#	scale_y_log10(limits=c(10,NA), breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
  ...
  ease_aes('linear') +
	labs(subtitle = "Date: {frame_time}")	-> p  
	animate(p, width = 1920/2, height = 1080/2, fps=10, duration=20, end_pause=10, rewind=TRUE)  %>%
	anim_save("USAnimationCapita.gif", animation = .)
}	
...
```{r, fig.width=21}
knitr::include_graphics("USAnimationCapita.gif")
```
!![Cases and deaths over time animation](USAnimationCapita.gif)
...
USStates.Covid19.all %>%
  ...
  #scale_x_continuous(limits=c(10,NA), trans="log10",breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
	scale_x_log10(limits=c(1,NA), breaks = logTicks(n=5),  minor_breaks = logTicks(n=50), labels = trans_format("log10", math_format(10^.x))) +
	annotation_logticks(sides="bt") +
	scale_y_continuous(limits=c(-1,5), trans="identity", labels = scales::percent_format(accuracy = 1)) +
	labs(title="New Cases and Acceleration", subtitle = paste("Covid19 pandemic","-",date()), x="average new cases per day", y="Relative Increase (%)") +
	theme_bw() + 
...
USStates.Covid19.all %>%
  ...
  #scale_x_continuous(limits=c(10,NA), trans="log10",breaks = trans_breaks("log10", function(x) 10^x), labels = trans_format("log10", math_format(10^.x))) +
	...
	annotation_logticks(sides="bt") +
	scale_y_continuous(limits=c(-1,5), trans="identity", labels = scales::percent_format(accuracy = 1)) +
	labs(title="New Cases per Capita and Acceleration", subtitle = paste("Covid19 pandemic","-",date()), x="Average new cases per Capita per day", y="Relative Increase (%)") +
	theme_bw() + 
	transition_time(Date, range=c(date("2020-04-01"),max(USStates.Covid19.all$Date))) +
  ease_aes('linear') +
	labs(subtitle = "Date: {frame_time}")	-> p3  
	animate(p3, width = 1920/2, height = 1080/2, fps=10, duration=20, end_pause=10) %>%
	anim_save("USAnimation2Capita.gif", animation = .)	
}	
```
...
```{r, fig.width=21}
knitr::include_graphics("USAnimation2Capita.gif")
```
!![Cases and deaths over time animation](USAnimation2Capita.gif)
